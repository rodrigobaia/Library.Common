...
{
    /// <summary>
	/// Escreve valor monetário por extenso
	/// </summary>
	public static class CurrencyWritenExtensiveExtender
    {
        ...
        //public static string NumeroPorExtenso(this decimal dec, decimal decNumero)
        /// <summary>
        ...
        public static string ExtensiceNumber(this decimal value)
        {
            ...
            if ((value >= decMin) && (value <= decMax))
            {

                Int64 intInteiro = Convert.ToInt64(Math.Truncate(value));

                Int64 intCentavos = Convert.ToInt64(Math.Truncate((value - Math.Truncate(value)) * 100));
